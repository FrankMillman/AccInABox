  ...
  for (var i=0; i<tool_list.length; i++) {
    ...
    switch(tool.type) {
      case 'btn': {
        ...
        btn.onclick = function(e) {
          ...
          if (tool.shortcut !== null) {
            ...
            page.kbd_shortcuts[type_key[0]][type_key[1]] = btn;
          };
      ...
      case 'nav': {
        ...
        page.kbd_shortcuts['ctrl']['Home'] = nav;
        ...
        page.kbd_shortcuts['ctrl']['ArrowUp'] = nav;
        toolbar.appendChild(nav);
        ...
        page.kbd_shortcuts['ctrl']['ArrowDown'] = nav;
        toolbar.appendChild(nav);
        ...
        page.kbd_shortcuts['ctrl']['End'] = nav;
        toolbar.appendChild(nav);
        break;
        }
      case 'text': {
