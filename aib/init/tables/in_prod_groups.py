# table definition
table = {
    'table_name'    : 'in_prod_groups',
    'module_id'     : 'in',
    'short_descr'   : 'Product groups',
    'long_descr'    : 'Product groups',
    'sub_types'     : None,
    'sub_trans'     : None,
...
cols.append ({
    'col_name'   : 'prod_group',
    'data_type'  : 'TEXT',
    'short_descr': 'Product group',
    'long_descr' : 'Product group',
    'col_head'   : 'Group',
    'key_field'  : 'A',
    'calculated' : False,
    'allow_null' : False,
...
cols.append ({
    'col_name'   : 'group_type',
    'data_type'  : 'TEXT',
    'short_descr': 'Type of prod group',
    'long_descr' : 'Type of product group',
    'col_head'   : 'Type',
    'key_field'  : 'N',
    'calculated' : False,
    'allow_null' : False,
...
cols.append ({
    ...
    'dflt_rule'  : None,
    'col_checks' : None,
    'fkey'       : ['in_prod_groups', 'row_id', 'parent', 'prod_group', False, None],
    'choices'    : None,
    })
cols.append ({
    'col_name'   : 'seq',
...
virt.append ({
    ...
    'col_head'   : '',
    'sql'        : "CASE WHEN EXISTS(SELECT * FROM {company}.in_prod_groups WHERE deleted_id = 0) "
                   "THEN 0 ELSE 1 END",
    })
virt.append ({
    'col_name'   : 'children',
    ...
    'col_head'   : '',
    'sql'        : "SELECT count(*) FROM {company}.in_prod_groups b "
