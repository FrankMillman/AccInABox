# table definition
table = {
    'table_name'    : 'adm_tax_rates',
    'module_id'     : 'adm',
    'short_descr'   : 'Sales tax rates',
    'long_descr'    : 'Sales tax rates',
    'sub_types'     : None,
    'sub_trans'     : None,
    'sequence'      : None,
    'tree_params'   : None,
...
cols.append ({
    ...
    'dflt_rule'  : None,
    'col_checks' : None,
    'fkey'       : ['adm_tax_codes', 'row_id', 'tax_cat, tax_code', 'tax_cat, tax_code', True, None],
    'choices'    : None,
    })
cols.append ({
    'col_name'   : 'eff_date',
...
cols.append ({
    ...
    'max_len'    : 0,
    'db_scale'   : 2,
    'scale_ptr'  : 'tax_code_id>tax_cat_id>scale',
    'dflt_val'   : None,
    'dflt_rule'  : None,
    'col_checks' : None,
    'fkey'       : None,
