    ...
    'upd_on_post', [
        ...
        [
            ...
            [  # condition
                ...
                ['and', '', 'subcrn_row_id>tran_det_row_id>pch_type', '=', "'acc'", ''],
                ],
            False,  # split source?
            [  # key fields
                ['gl_code_id', 'subcrn_row_id>npch_code_id>uex_gl_code_id'],  # tgt_col, src_col
                ['location_row_id', 'subcrn_row_id>location_row_id'],
                ['function_row_id', 'subcrn_row_id>function_row_id'],
                ['source_code', "'npch_cex'"],
                ['tran_date', 'eff_date'],
        ...
        [
            ...
            False,  # split source?
            [  # key fields
                ['gl_code_id', 'subcrn_row_id>npch_code_id>gl_code_id'],  # tgt_col, src_col
                ['location_row_id', 'subcrn_row_id>location_row_id'],
                ['function_row_id', 'subcrn_row_id>function_row_id'],
                ['source_code', "'npch_cex'"],
                ['tran_date', 'eff_date'],
        ...
        [
            ...
            [  # condition
                ['where', '', '_param.gl_integration', 'is', '$True', ''],
                ['and', '', 'subcrn_row_id>tran_det_row_id>pch_type', '=', "'cash'", ''],
                ],
            False,  # split source?
            [  # key fields
                ['gl_code_id', 'subcrn_row_id>npch_code_id>uex_gl_code_id'],  # tgt_col, src_col
