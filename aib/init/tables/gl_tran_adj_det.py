# table definition
table = {
    'table_name'    : 'gl_tran_adj_det',
    'module_id'     : 'gl',
    'short_descr'   : 'Gl y/e adj line items',
    'long_descr'    : 'G/ledger y/end adjustments line items',
    'sub_types'     : None,
    'sub_trans'     : [
...
cols.append ({
    ...
    'dflt_rule'  : None,
    'col_checks' : None,
    'fkey'       : ['gl_tran_adj', 'row_id', None, None, True, None],
    'choices'    : None,
    })
cols.append ({
    'col_name'   : 'line_no',
