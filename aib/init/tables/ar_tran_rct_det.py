    ...
    'sub_trans'     : [
        ['line_type', 'display_descr', [
            ['arec', 'Ar receipt', 'ar_subtran_rec',
                [  # return values
                    ['rec_amt', 'arec_amount'],  # tgt_col, src_col
                    ],
...
cols.append ({
    'col_name'   : 'rec_amt',
    'data_type'  : 'DEC',
    'short_descr': 'Rec amount',
    'long_descr' : 'Receipt amount in transaction currency - updated when subtran is saved',
    'col_head'   : 'Rec amt',
    'key_field'  : 'N',
    'calculated' : False,
    'allow_null' : False,
...
actions.append([
    'upd_on_save', [
        [
            ...
            [],  # key fields
            [  # aggregation
                ['amount_tran', '+', 'rec_amt'],  # tgt_col, op, src_col
