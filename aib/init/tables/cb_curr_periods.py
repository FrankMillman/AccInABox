# table definition
table = {
    'table_name'    : 'cb_curr_periods',
    'module_id'     : 'cb',
    'short_descr'   : 'Cb current periods',
    'long_descr'    : 'Current periods for cb ledgers',
    'sub_types'     : None,
    'sub_trans'     : None,
    'sequence'      : None,
    'tree_params'   : None,
...
virt.append ({
    ...
    'sql'        : (
        ...
        "WHERE b.row_id = a.current_period AND c.row_id = b.row_id - 1"
        ),
    })
virt.append ({
    'col_name'   : 'cl_date',
    ...
    'sql'        : (
        ...
        "WHERE b.row_id = a.current_period"
        ),
    })
