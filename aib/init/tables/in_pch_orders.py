...
cols.append ({
    ...
    'dflt_rule'  : (
        '<case>'
          # '<compare src="currency_id" op="eq" tgt="wh_row_id>currency_id">'
          #   '<literal value="1"/>'
          # '</compare>'
          ...
          #     '<op type="/"/>'
          #     '<exch_rate>'
          #       '<fld_val name="wh_row_id>currency_id"/>'
          ...
          #   '</expr>'
          # '</default>'
          '<compare src="wh_row_id>currency_id" op="eq" tgt="_param.local_curr_id">'
            '<literal value="1"/>'
          '</compare>'
          '<default>'
            '<exch_rate>'
