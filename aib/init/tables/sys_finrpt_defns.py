...
#     'long_descr' : 'Date parameters - single / fin_yr[desc] / last_n_per[desc, args]',
#     'col_head'   : 'Dates',
#     'key_field'  : 'N',
#     'data_source': 'input',
#     'condition'  : None,
...
cols.append ({
    'col_name'   : 'filters',
    'data_type'  : 'JSON',
    'short_descr': 'Filter parameters',
    'long_descr' : 'Filter parameters - {code/loc/fun/src: [[WHERE ...]]}',
    'col_head'   : 'Groups',
    'key_field'  : 'N',
    'data_source': 'input',
    'condition'  : None,
...
cols.append ({
    ...
    'long_descr' : 'Group parameters - {code/loc/fun/src: code_level / lf_level / src_type}',
    'col_head'   : 'Groups',
    'key_field'  : 'N',
    'data_source': 'input',
    'condition'  : None,
