# table definition
table = {
    'table_name'    : 'pch_ipch_crntax',
    'module_id'     : 'pch',
    'short_descr'   : 'Pch tax on inv cr note items',
    'long_descr'    : 'Purchase tax on inventory credit note items',
    'sub_types'     : None,
    'sub_trans'     : None,
    'sequence'      : None,
    'tree_params'   : None,
...
cols.append ({
    'col_name'   : 'ipch_row_id',
    'data_type'  : 'INT',
    'short_descr': 'Ipch row id',
    'long_descr' : 'Ipch row id',
    'col_head'   : 'Ipch det id',
    'key_field'  : 'A',
    'calculated' : False,
    'allow_null' : False,
    'allow_amend': False,
    ...
    'dflt_rule'  : None,
    'col_checks' : None,
    'fkey'       : ['pch_ipch_subcrn', 'row_id', None, None, True, None],
    'choices'    : None,
    })
cols.append ({
...
cols.append ({
    ...
    'max_len'    : 0,
    'db_scale'   : 2,
    'scale_ptr'  : 'ipch_row_id>tran_det_row_id>tran_row_id>currency_id>scale',
    'dflt_val'   : '0',
    'dflt_rule'  : None,
    'col_checks' : None,
    'fkey'       : None,
...
virt.append ({
    ...
    'col_head'   : 'Posted?',
    'dflt_val'   : '{ipch_row_id>tran_det_row_id>tran_row_id>posted}',
    'sql'        : "a.ipch_row_id>tran_det_row_id>tran_row_id>posted"
    })
virt.append ({
    'col_name'   : 'tax_local',
    'data_type'  : 'DEC',
    ...
    'dflt_rule'  : (
        '<expr>'
          ...
          '<op type="/"/>'
          '<fld_val name="ipch_row_id>tran_det_row_id>tran_row_id>tran_exch_rate"/>'
        '</expr>'
        ),
    'sql'        : (
        "a.tax_amt / a.ipch_row_id>tran_det_row_id>tran_row_id>tran_exch_rate"
        ),
    })
...
actions.append([
    'upd_on_post', [
        ...
        #         ],
        #     [  # aggregation
        #         ['ipch_crn_net_day', '-', 'ipch_row_id>net_local'],
        #         ['ipch_crn_tax_day', '-', 'tax_local'],
        #         ['ipch_crn_net_tot', '-', 'ipch_row_id>net_local'],
        #         ['ipch_crn_tax_tot', '-', 'tax_local'],
        #         ],
        #     [],  # on post
        #     [],  # on unpost
        #     ],
