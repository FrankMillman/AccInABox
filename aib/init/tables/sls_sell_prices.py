# table definition
table = {
    'table_name'    : 'sls_sell_prices',
    'module_id'     : 'sls',
    'short_descr'   : 'Selling prices',
    'long_descr'    : 'Selling prices',
    'sub_types'     : None,
    'sub_trans'     : None,
    'sequence'      : None,
    'tree_params'   : None,
...
cols.append ({
    ...
    'dflt_rule'  : None,
    'col_checks' : None,
    'fkey'       : ['in_prod_codes', 'row_id', 'prod_code', 'prod_code', True, 'prod_codes'],
    'choices'    : None,
    })
cols.append ({
    'col_name'   : 'eff_date',
...
cols.append ({
    'col_name'   : 'sell_price',
    'data_type'  : 'DEC',
    'short_descr': 'Selling price',
    'long_descr' : 'Selling price',
    'col_head'   : 'Sell price',
    'key_field'  : 'N',
    'calculated' : False,
    'allow_null' : False,
