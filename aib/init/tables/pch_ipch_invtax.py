# table definition
table = {
    'table_name'    : 'pch_ipch_invtax',
    'module_id'     : 'pch',
    'short_descr'   : 'Pch tax on inv invoice items',
    'long_descr'    : 'Purchase tax on inventory invoice items',
    'sub_types'     : None,
    'sub_trans'     : None,
    'sequence'      : None,
    'tree_params'   : None,
...
cols.append ({
    ...
    'dflt_rule'  : None,
    'col_checks' : None,
    'fkey'       : ['pch_ipch_subinv', 'row_id', None, None, True, None],
    'choices'    : None,
    })
cols.append ({
