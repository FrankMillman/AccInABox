...
cols.append ({
    ...
    'key_field'  : 'A',
    'data_source': 'dflt_if',
    'condition'  : [['where', '', 'ledger_row_id>auto_pmt_no', 'is not', '$None', '']],
    'allow_null' : False,
    'allow_amend': False,
    'max_len'    : 15,
    'db_scale'   : 0,
        ...
        '<case>'
          ...
          '<on_post>'
            '<case>'
              '<compare test="[[`if`, ``, `ledger_row_id>auto_temp_no`, `is not`, `$None`, ``]]">'
                '<auto_gen args="ledger_row_id>auto_pmt_no"/>'
              '</compare>'
              '<default>'
                '<fld_val name="tran_number"/>'
              '</default>'
          ...
          '<on_insert>'
            '<case>'
              ...
              '</compare>'
              '<compare test="[[`if`, ``, `ledger_row_id>auto_pmt_no`, `is not`, `$None`, ``]]">'
                '<auto_gen args="ledger_row_id>auto_pmt_no"/>'
              '</compare>'
            '</case>'
          '</on_insert>'
...
cursors = []
cursors.append({
    'cursor_name': 'posted_pmt',
    'title': 'Posted cb payments',
    'columns': [
        ['tran_number', 100, False, True],
        ['tran_date', 84, False, True],
        ['payee', 200, False, True],
