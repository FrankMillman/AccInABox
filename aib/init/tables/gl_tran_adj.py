    # table definition
table = {
    'table_name'    : 'gl_tran_adj',
    'module_id'     : 'gl',
    'short_descr'   : 'Gl y/e adj',
    'long_descr'    : 'G/ledger yearend adjustments',
    'sub_types'     : None,
    'sub_trans'     : None,
    'sequence'      : None,
    'tree_params'   : None,
...
virt.append ({
    ...
    'sql'        : "SELECT row_id FROM {company}.adm_tran_types WHERE tran_type = 'gl_adj'",
    })
virt.append ({
