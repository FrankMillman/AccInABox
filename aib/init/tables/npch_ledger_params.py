# table definition
table = {
    'table_name'    : 'npch_ledger_params',
    'module_id'     : 'npch',
    'short_descr'   : 'Non-inv purchases parameters',
    'long_descr'    : 'Non-inventory purchases parameters',
    'sub_types'     : None,
    'sub_trans'     : None,
    'sequence'      : None,
    'tree_params'   : None,
...
virt.append ({
    ...
    'sql'        : (
        "CASE "
            "WHEN (SELECT COUNT(*) FROM {company}.npch_groups b "
                "WHERE b.ledger_row_id = a.row_id AND b.deleted_id = 0) = 1 THEN "
                "(SELECT b.row_id FROM {company}.npch_groups b "
