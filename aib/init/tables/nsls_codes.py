...
cols.append ({
    ...
    'long_descr' : 'Ledger row id. Could be derived from group_id, but this allows non-unique nsls codes.',
    'col_head'   : 'Ledger',
    'key_field'  : 'A',
    'data_source': 'ctx',
    'condition'  : None,
    ...
    'fkey'       : ['nsls_ledger_params', 'row_id', 'ledger_id', 'ledger_id', False, 'nsls_ledg'],
    'choices'    : None,
    })
cols.append ({
    'col_name'   : 'nsls_code',
...
cols.append ({
    ...
    'key_field'  : 'N',
    'data_source': 'dflt_if',
    'condition'  : [['where', '', 'ledger_row_id>nsls_group_row_id', 'is not', '$None', '']],
    'allow_null' : False,
    'allow_amend': True,
    'max_len'    : 0,
    'db_scale'   : 0,
    'scale_ptr'  : None,
    'dflt_val'   : '{ledger_row_id>nsls_group_row_id}',
    'dflt_rule'  : None,
    'col_checks' : [
        [
            'ledger_id',
    ...
    'fkey'       : ['nsls_groups', 'row_id', 'grp_ledg, group', 'ledger_id, nsls_group', False, None],
    'choices'    : None,
    })
cols.append ({
    'col_name'   : 'seq',
    ...
    'col_checks' : [
        [
            ...
            [
                ...
                ['or', '', '$value', 'pyfunc', 'db.checks.valid_loc_id,ledger_row_id>gl_code_id', ''],
                ],
            ],
        ],
    ...
    'col_checks' : [
        [
            ...
            [
                ...
                ['or', '', '$value', 'pyfunc', 'db.checks.valid_fun_id,ledger_row_id>gl_code_id', ''],
                ],
            ],
        ],
...
virt.append ({
    ...
    'long_descr' : 'Any text codes for this nsls code?',
    'col_head'   : '',
    'sql'        : (
        "CASE WHEN EXISTS(SELECT * FROM {company}.nsls_tax_codes b "
            "WHERE b.nsls_code_id = a.row_id AND b.deleted_id = 0) "
