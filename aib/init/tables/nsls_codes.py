...
table = {
    ...
    'tree_params'   : ['group_row_id', ['nsls_code', 'descr', None, 'seq'], None],
    'roll_params'   : None,
    'indexes'       : None,
...
cols.append ({
    ...
    'long_descr' : 'Ledger row id. Could be derived from group_row_id, but this allows non-unique nsls codes.',
    'col_head'   : 'Ledger',
    'key_field'  : 'A',
    'data_source': 'ctx',
    'condition'  : None,
