# table definition
table = {
    'table_name'    : 'nsls_tax_codes',
    'module_id'     : 'nsls',
    'short_descr'   : 'Sls tax codes - non-inventory',
    'long_descr'    : 'Sales tax codes - non-inventory',
    'sub_types'     : None,
    'sub_trans'     : None,
    'sequence'      : None,
    'tree_params'   : None,
...
cols.append ({
    ...
    'dflt_rule'  : None,
    'col_checks' : None,
    'fkey'       : ['nsls_codes', 'row_id', 'ledger_id, nsls_code', 'ledger_id, nsls_code', True, 'nsls_codes'],
    'choices'    : None,
    })
cols.append ({
