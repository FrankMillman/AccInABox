...
cols.append ({
    ...
    'key_field'  : 'N',
    'calculated' : [['where', '', '_param.use_locations', 'is', '$False', '']],
    'allow_null' : False,
    'allow_amend': True,
    'max_len'    : 0,
    'db_scale'   : 0,
...
cols.append ({
    ...
    'data_type'  : 'BOOL',
    'short_descr': 'Add function id to suppliers?',
    'long_descr' : 'Add function id to suppliers? If not, use function root',
    'col_head'   : 'Use functions?',
    'key_field'  : 'N',
    'calculated' : [['where', '', '_param.use_functions', 'is', '$False', '']],
    'allow_null' : False,
    'allow_amend': True,
    'max_len'    : 0,
    'db_scale'   : 0,
...
cols.append ({
    ...
    'long_descr' : 'Use common function for all suppliers?',
...
cols.append ({
    ...
    'long_descr' : 'Common function row id - all suppliers will share this function',
    'col_head'   : 'Common',
    'key_field'  : 'N',
    'calculated' : False,
    'allow_null' : True,
...
cols.append ({
    ...
    'data_type'  : 'BOOL',
    'short_descr': 'Multiple funs for suppliers?',
    'long_descr' : 'Allow multiple functions for suppliers?',
