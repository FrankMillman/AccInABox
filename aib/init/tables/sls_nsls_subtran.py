...
cols.append ({
    ...
    'key_field'  : 'N',
    'data_source': 'dflt_if',
    'condition'  : [['where', '', 'nsls_code_id>valid_loc_ids>expandable', 'is', '$False', '']],
    'allow_null' : False,
    'allow_amend': False,
    'max_len'    : 0,
    'db_scale'   : 0,
    ...
    'dflt_rule'  : (
        '<case>'
          ...
          '<compare test="[[`if`, ``, `tran_det_row_id>module_id`, `=`, `~ar~`, ``]]">'
            '<fld_val name="tran_det_row_id>cust_row_id>location_row_id"/>'
          '</compare>'
        '</case>'
        ),
    'col_checks' : [
...
cols.append ({
    ...
    'key_field'  : 'N',
    'data_source': 'dflt_if',
    'condition'  : [['where', '', 'nsls_code_id>valid_fun_ids>expandable', 'is', '$False', '']],
    'allow_null' : False,
    'allow_amend': False,
    'max_len'    : 0,
    'db_scale'   : 0,
    ...
    'dflt_rule'  : (
        '<case>'
          ...
          '</compare>'
          '<compare test="[[`if`, ``, `tran_det_row_id>module_id`, `=`, `~ar~`, ``]]">'
            '<fld_val name="tran_det_row_id>cust_row_id>function_row_id"/>'
          '</compare>'
        '</case>'
        ),
    'col_checks' : [
...
actions.append([
    'upd_on_post', [
        ...
        [
            ...
            [  # key fields
                ['nsls_code_id', 'nsls_code_id'],  # tgt_col, src_col
                ['cust_row_id', 'tran_det_row_id>cust_row_id'],
                ['location_row_id', 'location_row_id'],
                ['function_row_id', 'function_row_id'],
                ['source_code_id', 'source_code_id'],
                ['tran_date', 'tran_det_row_id>tran_date'],
