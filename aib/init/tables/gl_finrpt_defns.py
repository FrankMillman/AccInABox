# table definition
table = {
    'table_name'    : 'gl_finrpt_defns',
    'module_id'     : 'gl',
    'short_descr'   : 'Gl fin rpt definitions',
    'long_descr'    : 'Financial report definitions - gl module',
    'sub_types'     : None,
    'sub_trans'     : None,
    'sequence'      : None,
    'tree_params'   : None,
...
cols.append ({
    ...
    'long_descr' : 'Group parameters - outer=code/loc/fun/src, inner=type, group name, filter',
    'col_head'   : 'Groups',
    'key_field'  : 'N',
    'data_source': 'input',
    'condition'  : None,
