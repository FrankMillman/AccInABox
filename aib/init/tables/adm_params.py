...
cols.append ({
    'col_name'   : 'allow_alloc_pmt',
    'data_type'  : 'BOOL',
    'short_descr': 'Allow payment allocation?',
    'long_descr' : 'Allow payment allocation while entering payment?',
    'col_head'   : 'Allow pmt alloc?',
    'key_field'  : 'N',
    'data_source': 'input',
    'condition'  : None,
    'allow_null' : False,
