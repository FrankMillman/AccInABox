# table definition
table = {
    'table_name'    : 'npch_tax_codes',
    'module_id'     : 'npch',
    'short_descr'   : 'Pch tax codes - non-inventory',
    'long_descr'    : 'Purchase tax codes - non-inventory',
    'sub_types'     : None,
    'sub_trans'     : None,
    'sequence'      : None,
    'tree_params'   : None,
...
cols.append ({
    ...
    'dflt_rule'  : None,
    'col_checks' : None,
    'fkey'       : ['npch_codes', 'row_id', 'ledger_id, npch_code', 'ledger_id, npch_code', True, 'npch_codes'],
    'choices'    : None,
    })
cols.append ({
