...
cols.append ({
    ...
    'col_head'   : 'Inv no',
    'key_field'  : 'A',
    'calculated' : ['_ledger.auto_inv_no', 'is_not', None],
    'allow_null' : False,
    'allow_amend': False,
    'max_len'    : 15,
    'db_scale'   : 0,
...
actions.append([
    'upd_on_post', [
        ...
        [
            ...
            [  # aggregation
                ['inv_net_day_cus', '+', 'inv_net_cust'],  # tgt_col, op, src_col
                ['inv_tax_day_cus', '+', 'inv_tax_cust'],
                ['inv_net_tot_cus', '+', 'inv_net_cust'],
                ['inv_tax_tot_cus', '+', 'inv_tax_cust'],
