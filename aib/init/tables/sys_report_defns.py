# table definition
table = {
    'table_name'    : 'sys_report_defns',
    'module_id'     : 'sys',
    'short_descr'   : 'Report definitions',
    'long_descr'    : 'Report definitions',
    'sub_types'     : None,
    'sub_trans'     : None,
    'sequence'      : None,
    'tree_params'   : None,
...
cols.append ({
    'col_name'   : 'report_xml',
    'data_type'  : 'RXML',
    'short_descr': 'Report definition',
    'long_descr' : 'Report definition - gzip\'d xml',
    'col_head'   : 'Xml',
    'key_field'  : 'N',
    'calculated' : False,
    'allow_null' : True,
