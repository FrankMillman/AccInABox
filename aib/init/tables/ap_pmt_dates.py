# table definition
table = {
    'table_name'    : 'ap_pmt_dates',
    'module_id'     : 'ap',
    'short_descr'   : 'Ap payment dates',
    'long_descr'    : 'Ap payment dates',
    'sub_types'     : None,
    'sub_trans'     : None,
    'sequence'      : None,
    'tree_params'   : None,
...
cols.append ({
    ...
    'dflt_val'   : None,
    'dflt_rule'  : None,
#   'col_checks' : [['match_ledger', 'Must be part of same ledger', [
...
cols.append ({
    'col_name'   : 'completed',
    'data_type'  : 'BOOL',
    'short_descr': 'Payment close completed?',
    'long_descr' : 'Payment close completed?',
    'col_head'   : 'Completed?',
    'key_field'  : 'N',
    'calculated' : False,
    'allow_null' : False,
...
virt.append ({
    ...
    'col_head'   : '',
    'dflt_val'   : '{supp_row_id>ledger_row_id}',
    'dflt_rule'  : None,
    'sql'        : "SELECT a.supp_row_id>ledger_row_id"
    })
"""
