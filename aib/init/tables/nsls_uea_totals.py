...
table = {
    ...
    'module_id'     : 'nsls',
    'short_descr'   : 'Non-inv sales unearned totals',
    'long_descr'    : 'Non-inventory sales unearned totals',
    'sub_types'     : None,
    'sub_trans'     : None,
    'sequence'      : None,
    'tree_params'   : None,
...
cols.append ({
    ...
    'dflt_rule'  : None,
    'col_checks' : None,
    'fkey'       : ['nsls_codes', 'row_id', 'ledger_id, nsls_code', 'ledger_id, nsls_code', False, None],
    'choices'    : None,
    })
cols.append ({
