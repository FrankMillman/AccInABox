...
<form name="form_setup_outputs">
  ...
  <mem_objects>
    ...
    <mem_obj name="outputs" descr="Output parameters" parent="form">
      <mem_col col_name="form_name" data_type="TEXT" short_descr="Form name"
      ...
      <mem_col col_name="name" data_type="TEXT" short_descr="Name"
        long_descr="Output parameter name" col_head="Name" key_field="A" allow_null="false"
        allow_amend="false" max_len="20" db_scale="0"/>
      ...
      <mem_col col_name="source" data_type="TEXT" short_descr="Source"
        long_descr="Output parameter source" col_head="Source" key_field="N" allow_null="false"
        allow_amend="true" max_len="20" db_scale="0"/>
    </mem_obj>
  ...
  <frame main_object="form">
    ...
    <body>
      ...
      <grid data_object="outputs" growable="true" num_grid_rows="5">
        <cur_columns>
          ...
          <cur_col col_name="source" lng="120" expand="true"/>
        </cur_columns>
        <cur_filter/>
        <cur_sequence/>
    ...
    <frame_methods template="Setup_Form">
      <method name="on_start_form" action="
        <<action>>
          <<pyfunc name=`db.formdefn_funcs.load_output_params`/>>
        <</action>>
      "/>
      <method name="do_save" action="
        <<action>>
          <<pyfunc name=`db.formdefn_funcs.dump_output_params`/>>
        <</action>>
      "/>
      <method name="do_restore" action="
        <<action>>
          <<pyfunc name=`db.formdefn_funcs.restore_output_params`/>>
        <</action>>
      "/>
    </frame_methods>
  </frame>
