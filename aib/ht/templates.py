    ...
    frame_methods = (
        '<frame_methods>'
          ...
          '<method name="on_req_close" action="'  # click [X] or press Shift+F4
            ...
            '&lt;/action&gt;'
          '"/>'
          '<method name="save_parent" action="'
            '&lt;action&gt;'
              '&lt;case&gt;'
...
# need to be 100% sure it is never called on a failed read before removing
          ...
          '<method name="on_req_close" action="'  # click [X] or press Shift+F4
            '&lt;action&gt;'
              '&lt;case&gt;'
                '&lt;data_changed&gt;'
                  '&lt;ask title=&quot;Save changes [from grid_method]?&quot; enter=&quot;No&quot; escape=&quot;Cancel&quot; '
                      'question=&quot;Do you want to save changes to {obj_descr}?&quot;&gt;'
                    '&lt;response ans=&quot;Yes&quot;&gt;'
                      '&lt;validate_all/&gt;'
                      '&lt;call method=&quot;do_save&quot;/&gt;'
        ...
        '<frame_methods>'
          '<method name="on_req_close" action="'  # click [X] or press Shift+F4
            '&lt;action&gt;'
              '&lt;case&gt;'
                '&lt;data_changed&gt;'
                  '&lt;ask title=&quot;Save changes [from frame_method]?&quot; enter=&quot;No&quot; escape=&quot;Cancel&quot; '
                      'question=&quot;Do you want to save changes to {obj_descr}?&quot;&gt;'
                    '&lt;response ans=&quot;Yes&quot;&gt;'
                      '&lt;validate_all/&gt;'
                      '&lt;call method=&quot;do_save&quot;/&gt;'
